...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-slate-50 flex flex-col mt-10">
            <div className='grid lg:grid-cols-4 w-full md:grid-cols-2 sm:grid-cols-2 grid-cols-1 mx-auto mb-4'>
                ...
                <div className='text-neutral mt-4'>
                    ...
                    <div className='flex flex-col gap-y-2 mt-4'>
                        <h4 className="text-lg link-hover link">Computer And Accessories</h4>
                        <h4 className="text-lg link-hover link">Smartphone and Tablets</h4>
                        <h4 className="text-lg link-hover link">TV Audio & Video</h4>
                        <h4 className="text-lg link-hover link">Cameras Drone & Gimbal</h4>
                    </div>
                </div>
                <div className='mt-4'>
                    <h3 className=' text-2xl font-bold'>Download App</h3>
                    <div className="flex flex-col gap-4 mt-4">
                        <div className="flex items-center border rounded-lg px-4 py-2 w-52 hover:bg-slate-100 transition-all duration-200">
            ...
            <div className='w-full flex flex-col items-center justify-center'>
                ...
                <p className='m-0 p-0'>Copyright © 2023 - All right reserved by <span className='font-bold'>E - Shop</span></p>
            </div>
        </footer>
    );
};
