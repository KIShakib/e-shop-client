        ...
        <div className="flex flex-col justify-evenly bg-slate-50 hover:shadow-[0_0px_35px_-15px_rgba(50,130,173,0.8)] rounded w-full hover:bg-slate-100 text-[#183661]">
            ...
            <div className="p-5 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between">
                    <h4 className="text-xl text-[#183661]">BDT <span className='text-2xl font-bold'>{price}</span></h4>
                    <button className="bg-[#183661] hover:bg-[#183680] text-white font-medium rounded px-5 py-1 text-center">
                        Details
                    </button>
                </div>
            </div>
