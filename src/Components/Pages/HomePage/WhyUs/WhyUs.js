...
const WhyUs = () => {
    return (
        <section className='lg:mb-20 lg:px-10 px-5'>
            <div className="mx-auto text-center">
                <h1 className="mb-5 text-3xl font-bold text-[#183661]">Why You Should Buy From Us</h1>
            </div>
            <div className='grid lg:grid-cols-3 gap-2'>
                <div className='flex flex-col items-center gap-y-4 border rounded-md p-4 bg-slate-50 hover:bg-slate-100 transition-all duration-200'>
                ...
                <div className='flex flex-col items-center gap-y-4 border rounded-md p-4 bg-slate-50 hover:bg-slate-100 transition-all duration-200'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        ...
                        <p className='text-center opacity-70'>Easy return with 100 transition-all duration-200% refund. Please visit refund policy.</p>
                    </div>
                </div>
            </div>
        </section>
